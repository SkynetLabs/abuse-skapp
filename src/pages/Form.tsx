// TODOs
//
// 1. should be refactored to a proper bootstrap form
// 2. notication color scheme not working
...
const ABUSE_ENDPOINT = DEBUG
  ? 'https://dev1.siasky.dev/abuse/report'
  : 'https://siasky.net/abuse/report';
...
export default function Form() {
  ...
  const { proof } = useContext(MySkyContext)
